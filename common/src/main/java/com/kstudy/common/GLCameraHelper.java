...
public class GLCameraHelper {
    private static final String TAG = "GLCameraHelper";
    ...
    private CameraHelper.OnChangedSizeListener mOnChangedSizeListener; // 回调接口 把宽和高 给外界的

    private SurfaceTexture mSurfaceTexture = null; // 从图像流中捕获帧作为 OpenGL ES 纹理
    ...
    public void setOnChangedSizeListener(CameraHelper.OnChangedSizeListener onChangedSizeListener) {
...
//            mCamera.setPreviewDisplay(mSurfaceHolder);
            ...
            // Camera相机预览数据 ---->  surfaceTexture纹理画布（不可见的画布） ---> OpenGL
