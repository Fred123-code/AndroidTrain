package com.kstudy.myopengl.face;
...
public class FaceTrack {
    static {
        System.loadLibrary("myopenGLjni");
    }

    private GLCameraHelper mGLCameraHelper; // 手机相机预览工具类（之前的内容）
     ...
     */
    public FaceTrack(String model, String seeta, GLCameraHelper cameraHelper) {
        mGLCameraHelper = cameraHelper;
        ...
        mHandler = new Handler(mHandlerThread.getLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                synchronized (FaceTrack.this) {
                    // 定位 线程中检测
                    mFace = native_detector(self, (byte[]) msg.obj, mGLCameraHelper.getCameraID(),640, 480);
                    if (mFace != null) {
